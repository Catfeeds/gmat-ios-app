...
//    _backgroundWindow.rootViewController = [[UIViewController alloc] init];
	...
	[self.indicatorView mas_updateConstraints:^(MASConstraintMaker *make) {
		make.center.mas_equalTo(self.backgroundWindow);
		make.width.height.mas_equalTo(SCCatWaiting_animationSize * 4.0f);
	}];
...
//	_backgroundWindow.hidden = false;
	...
	[_backgroundWindow mas_updateConstraints:^(MASConstraintMaker *make) {
