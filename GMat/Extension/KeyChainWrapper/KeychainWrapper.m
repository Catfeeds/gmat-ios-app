...
static const UInt8 kKeychainItemIdentifier[]    = "com.apple.ToeflTing_APP.KeychainUI\0";
...
- (void)resetKeychainItem
{
    ...
    [_keychainData setObject:@"GMATONLINE_APP" forKey:(__bridge id)kSecAttrService];
