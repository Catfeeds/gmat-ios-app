...
@interface HTTryListenModel : NSObject
...
@property (nonatomic, strong) NSString *backgroundImageForButton;
...
@property (nonatomic, copy) NSString *teacherData;
...
@property (nonatomic, strong) NSString *courseTeacherImage;

@property (nonatomic, strong) NSAttributedString *courseTeacherTitle;

@property (nonatomic, strong) NSAttributedString *courseTeacherDetail;
