//
//  HTCourseOpenOnlineVideoModel.h
//  GMat
//
...
@interface HTCourseOnlineVideoModel : NSObject

@property (nonatomic, copy) NSString *courseConnectTitle;


@property (nonatomic, copy) NSString *contentSmartApplythumb;
