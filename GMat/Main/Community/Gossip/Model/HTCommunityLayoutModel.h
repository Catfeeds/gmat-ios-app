...
//直播页帖子内容需要的高度,不计算回复高度
@property (nonatomic, assign) CGFloat totalHeightForLive;

//直播列表页面帖子所有回复高度和 ,最多显示5条
@property (nonatomic, assign)CGFloat totalHeightForLiveReply;

//直播列表页面单个回复高度
@property (nonatomic, strong)NSMutableArray *singleLiveReplyHeightArray;
