...
+ (NSArray <HTQuestionMoreMenuModel *> *)packModelArrayIsHiddenAnalysis:(BOOL)flag{
	...
	NSArray *keyValueArray = @[
							     @{itemTypeKey:@(HTQuestionMoreItemTypeParse), isHiddenKey:@(flag), titleNameKey:@"查看解析", isSelectedKey:@(false), selectedTitleKey:@"关闭解析"},
