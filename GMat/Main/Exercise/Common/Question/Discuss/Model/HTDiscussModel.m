...
- (void)mj_keyValuesDidFinishConvertingToObject {
	...
	[dic enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
		self.content = [self.content stringByReplacingOccurrencesOfString:(NSString *)key withString:(NSString *)obj];
	}];
	
	self.content= [self.content stringByReplacingOccurrencesOfString:@"nbsp;" withString:@" "];
