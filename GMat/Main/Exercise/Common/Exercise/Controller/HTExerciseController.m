		...
		[[sectionMaker.cellClass([HTExerciseCollectionCell class])
		  ...
		  .sectionInset(sectionInset) didSelectedCellBlock:^(UICollectionView *collectionView, NSInteger item, __kindof UICollectionViewCell *cell, __kindof HTExerciseCollectionModel *model) {
			  if (model.modelType == HTExerciseCollectionModelTypeReport) {
				  ...
				  NSString *tempQuestionType = nil;
				  switch (model.modelType) {
					  case HTExerciseCollectionModelTypeSingle:
						  tempQuestionType = Single;
						  break;
					  case HTExerciseCollectionModelTypePoint:
						  tempQuestionType = Point;
						  break;
					  case HTExerciseCollectionModelTypeHardly:
						  tempQuestionType = Hardly;
						  break;
					  case HTExerciseCollectionModelTypeMock:
						  tempQuestionType = Mock;
						  break;
					  case HTExerciseCollectionModelTypeSort:
						  tempQuestionType = Sort;
						  break;
					  default:
						  break;
				  }
				  //临时记录从哪个题库进去做题;
				  [[NSUserDefaults standardUserDefaults]setObject:tempQuestionType forKey:@"tempContinue"];
