...
/**
 ...
 @param replyContent 要回复的内容
 @param communitModel 打包的八卦的模型
 @param beingReplyModel 打包的要回复的楼层的模型 , 值为nil时为回复帖子
 */
...
/**
 ...
 @param liveIdString 要点赞或要取消点赞的直播 id
 */
...
/**
 ...
 @param titleString 发表标题
 @param detailString 发表内容
 @param imageSourceArray 发表的图片地址数组
 */
