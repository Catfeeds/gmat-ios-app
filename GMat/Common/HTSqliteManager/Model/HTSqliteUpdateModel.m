...
+ (NSDictionary *)objectClassInArray{
    return @{@"parse" : [HTSqliteParseModel class], @"question" : [HTSqliteQuestionModel class], @"tiku" : [HTSqliteExerciseModel class], @"xuhaoquestion":[HTSqliteSortQuestionModel class], @"xuhao":[HTSqliteSortExerciseModel class]};
}
@end
