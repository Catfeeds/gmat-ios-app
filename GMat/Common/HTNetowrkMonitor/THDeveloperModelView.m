...
+ (void)updateDeveloperModelView {
	NSString *developerValue = [[NSUserDefaults standardUserDefaults] stringForKey:@"developer_mode_key"];
	NSString *password = @"3q";
	BOOL isDeveloperModel = [password isEqualToString:developerValue];
    [THDeveloperModelView defaultDeveloperModelView].isDeveloperModel = isDeveloperModel;
//    if (isDeveloperModel) {
